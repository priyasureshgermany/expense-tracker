...
**Capture or select photo** offers the camera or your gallery — a receipt already
...
| Reports | Three readings of a stretch of time: a ring of expenses by category, five bars of income against expenses, and every line of it in a table you can filter, sort and export. The range is **1W / 1M / 1Y / 12M / Flex**, and every one of them **stops at today** — a report is of what has happened, not of what is planned for the months ahead. Flex is the exception, honouring the two dates you type. The bars count in whatever unit the range implies (days for a week, weeks for a month, months for a year), carry values up the side, and tap to read out the income and expense behind a column. Category and account each filter to as many as you like, and **Clear filters** puts them all back. Where a stretch runs past one month, each category also shows what it costs a month — a total over a year being comparable with nothing shorter. |
