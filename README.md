...
| Reminders | 🔔 in the top bar: what falls due in the next three days, each with the same tick the ledger has — and the same question about which day it was paid. Ticking one off here drops it from the list without opening it. |
